...
ActiveRecord::Schema.define(version: 20161207182545) do
  ...
  add_index "votes", ["downvotes"], name: "index_votes_on_downvotes", using: :btree
  add_index "votes", ["upvotes"], name: "index_votes_on_upvotes", using: :btree
